...
[§1.506](https://www.ecfr.gov/current/title-21/section-1.506) lists what counts:
...
Where a hazard has a **reasonable probability that exposure will result in serious adverse
health consequences or death** — SAHCODHA in FDA's shorthand — and the hazard is controlled
by the foreign supplier, §1.506(d)(2) requires:
...
- inspection by **FDA**, another federal agency, or a state or local agency; or
...
The audit must be performed by a **qualified auditor**, and the regulation is explicit that
...
[§1.505](https://www.ecfr.gov/current/title-21/section-1.505) requires evaluation and
approval of the supplier **before** importing, based on the hazard analysis and on the
...
- **Classify the hazard first.** SAHCODHA or not decides whether you are in the annual audit
  regime or choosing freely.
- **Ask what inspections already exist.** An FDA or recognised-authority inspection within
  the year can replace the audit you were about to buy.
- **Write the determination whenever you deviate**, at the time, with the reasoning.
- **Diarise the 3-year reevaluation** per supplier, and treat a change of process or a
  compliance event as an early trigger.
- **Keep the auditor's independence provable.** Who performed it, and their qualification,
  is part of the record.

Aleph keeps verification activities and their dates against the supplier and the product, so
"which approvals are past three years" is a filter rather than a spreadsheet.
