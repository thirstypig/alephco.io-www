...
[FSVP for the first-time importer](/blog/fsvp-for-the-first-time-importer.html).

## Provision one: you may adopt someone else's

[§1.504(d)](https://www.ecfr.gov/current/title-21/section-1.504) permits you to satisfy the
requirement by **reviewing and assessing a hazard analysis conducted by another entity** —
...
the review is the artefact you produce.

## Provision two: you may find nothing requiring a control
...
§1.504(a) requires a **written** analysis identifying and evaluating known or reasonably
foreseeable hazards "based on experience, illness data, scientific reports, and other
information".

§1.504(b) sets the three categories:

- **Biological** — including microbiological hazards, parasites and pathogens
- **Chemical** — including radiological hazards, pesticide and drug residues, natural
  toxins, decomposition, and **food allergens**
- **Physical** — stones, glass, metal fragments
...
§1.504(c) is where analyses get thin. You must assess **the probability the hazard will
occur in the absence of controls, and the severity** of the resulting illness or injury,
considering:

formulation · condition and design of the establishment and equipment · raw materials and
ingredients · transportation practices · harvesting, raising, manufacturing, processing and
...
[§1.503](https://www.ecfr.gov/current/title-21/section-1.503) asks for a qualified
...
- Your supplier has no hazard analysis, or one you cannot assess.
- The food carries a **SAHCODHA** hazard, where the verification regime is strict and the
  consequences of getting the analysis wrong are the point.
- Novel process, novel ingredient, or a category you have never handled.
...
to a qualified individual about your programme.*
