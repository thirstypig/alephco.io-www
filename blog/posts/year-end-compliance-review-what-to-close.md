---
title: "Year-end compliance review: what to close before 31 December"
description: "A dated checklist of the obligations that recur annually or expire quietly, with the rule behind each one, aimed at importers with a mixed catalogue."
date: 2026-12-28
slug: year-end-compliance-review-what-to-close
keywords: [year end compliance, annual review, importer checklist, FSVP reevaluation, periodic testing, PFAS reporting, Prop 65]
sources: [https://www.ecfr.gov/current/title-21/section-1.505, https://www.ecfr.gov/current/title-16/part-1107, https://www.revisor.mn.gov/statutes/cite/116.943, https://www.law.cornell.edu/regulations/california/27-CCR-25603, https://www.ecfr.gov/current/title-21/section-1.510]
draft: true
---
...
**6 September 2026**; verify anything you are about to act on.
...
[what FDA actually accepts](/blog/supplier-verification-what-fda-actually-accepts.html).

## Things that expire on a longer clock
...
**CPSC eFiling for foreign trade zone entries — 8 January 2027.** The main rule took effect
8 July 2026; FTZ entries for consumption or warehousing follow in January. If you use an
FTZ, this is next month's problem, not next year's.

## Things to check rather than schedule

**Certificates that name no rules.** 16 CFR §1110.11(a)(2) requires each applicable rule
listed separately. "Complies with all applicable CPSC regulations" does not meet it, and it
...
records must be kept **five years** (16 CFR §1107.26). Both are storage requirements
disguised as paperwork requirements.

## The one-hour version

If you do nothing else:

1. List supplier approvals older than 34 months.
2. List SKUs whose last third-party test is older than their interval.
3. List short-form Prop 65 labels still on the old content.
4. Send every active supplier the "what changed since [date]?" question.
...
*General information, not legal advice. Every item links to the rule behind it — check those
and talk to counsel about your obligations.*
